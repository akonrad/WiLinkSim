...
public class startExp {

    private static boolean newExperiment = false;
	...
	try {
	    ...
	    System.out.println("Error in opening the optionFile: startExp.java");
	}
	...
	frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	final startExp userInterface = new startExp();
